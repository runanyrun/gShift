...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    return applyResponseCookies(authResponse, toApiErrorResponse(error, "Failed to list job titles."));
  }
}
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    return applyResponseCookies(authResponse, toApiErrorResponse(error, "Failed to create job title."));
  }
}
